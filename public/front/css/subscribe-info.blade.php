...
<main>
  <div id="demo" class="carousel slide mt-md-5" data-ride="carousel">
      <div class="carousel-inner">
         <div class="carousel-item overflow-before active">
            <img src="{{url('')}}/public/front/img/proper-nutrition.png" alt="Proper nutrition is the key to unlock your full potential. Subscribe to our meals daily and enjoy abundant health and deliciousness." style="width: 100%">
              <div class="carousel-caption">
                <h3 class="text-white">Pre-workout nutrition is necessary for performance, Post-workout nutrition is necessary for progress.</h3>
              </div>
         </div>
         <div class="carousel-item overflow-before">
               ...
               <form  role="form" id="frm-subscribe-info" data-parsley-validate="parsley">
                  <div class="form-group" data-parsley-validate="parsley">
                     <div class="row ">
                       ...
                       <a href="{{url('')}}/faq" class="d-block text-dark text-center my-2"> 
         ...
         <div class="row align-items-stretch justify-content-center">
            <div class="mt-2 col-md-4 col-4 p-2">
               <div class="child-column-fueled text-center">
                  ...
                  <img src="{{url('')}}/public/front/img/bilder.svg" class="img-fluid" style="max-width: 60px;">
                  <h4 class="mb-0 mt-2" style="font-weight: 600;color: #1C2A39;">Perfect Protion</h4>
                  <p class="ff-paragraph">Meals packed with ingredients that satiate you for long.</p>
               </div>
            </div>
            <div class="mt-2 col-md-4 col-4 p-2">
               <div class="child-column-fueled text-center">
                  <!--<img src="{{url('')}}/public/front/img/power-macros.svg" class="img-fluid" width="180">-->
                  <img src="{{url('')}}/public/front/img/macros-final.svg" class="img-fluid" style="max-width: 60px;">
                  <h4 class="mb-0 mt-2" style="font-weight: 600;color: #1C2A39;">Powerful Macros</h4>
            ...
            <div class="mt-2 col-md-4 col-4 p-2">
               <div class="child-column-fueled text-center">
                   <!--<img src="{{url('')}}/public/front/img/paleo-keto.svg" class="img-fluid" width="180">-->
                    <img src="{{url('')}}/public/front/img/delicious-food.svg" class="img-fluid" style="max-width: 60px;">
                    <h4 class="mb-0 mt-2" style="font-weight: 600;color: #1C2A39;">Delicious Taste</h4>

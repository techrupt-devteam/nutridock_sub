...
class NutritionsitController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if($is_exist)
        {
            ...
            Session::flash('error',"Email address alerady exist !!");
              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse: collapse;">
                <tr>
                  <td style="color: #1a2127; font-family: Arial, sans-serif;">
                    ...
                    <h2 style="margin: 0px;text-transform: uppercase font-family:arial, helvetica neue, helvetica, sans-serif;margin-top:0px">Hello, '.ucfirst($request->input('nutritionsit_name')).'</h2>
                  </td>
                </tr>
                <tr>
                  <td style="color: #222;font-family:arial, helvetica neue, helvetica,sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
                    <p style="margin: 0; font-family:arial, helvetica neue, helvetica, sans-serif;">To start using your Nutridock Fit account, login to Nutrionist Panel using following login credentials:</p>
                    <p style="font-family:arial, helvetica neue, helvetica, sans-serif;"><b>Nutridock Panel :</b> https://www.nutridockfit.com/admin</p>
                    <p style="font-family:arial, helvetica neue, helvetica, sans-serif;"><b>Username:</b> '.$request->input('nutritionsit_email').'</p>

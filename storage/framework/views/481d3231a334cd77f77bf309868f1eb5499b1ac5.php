...
<section class="breadcrumbs-custom">
    <div class="parallax-container" data-parallax-img="<?php echo e(url('')); ?>/public/front/img/faq-bg.jpg">
    	<div class="material-parallax parallax">
    		<img src="<?php echo e(url('')); ?>/public/front/img/faq-bg.jpg" alt="" style="display: block; transform: translate3d(-50%, 149px, 0px);">
    	</div>
                ...
                <div class="tab-pane filter-active " id="tab1">
                    <div class="container" data-aos="fade-up">
                        <ul class="faq-list" data-aos="fade-up" data-aos-delay="100">
                          ...
                          <li>
                            <a data-toggle="collapse" class="text-darkness" href="#faq<?php echo e($row['id']); ?>"> 
                              <span class="text-success"> <?php echo e($no++); ?>. </span> 
                              <?php echo e($row['title']); ?>

                                <i class="fa fa-angle-down"></i></a>
                            <div id="faq<?php echo e($row['id']); ?>" <?php if($row['id']==1): ?> class="collapse show" <?php endif; ?> class="collapse" data-parent=".faq-list">

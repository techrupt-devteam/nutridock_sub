  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo e(url('/')); ?>/admin/comm_home_banner">Manage <?php echo e($title); ?></a></li>
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?php echo e(url('/admin')); ?>/update_comm_home_banner/<?php echo e($data->id); ?>" method="post" role="form" data-parsley-validate="parsley" enctype="multipart/form-data">
              ...
              <div class="box-body">
                 <div class="form-group">
                   <label for="oldpassword">Image</label>
                        <center>
                          <img id="output_image1" height="200px" width="400px" src="https://www.marutiseva.com/<?php echo e($data->banner); ?>" />
                        </center>
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/marutiseva/public_html/admin/resources/views/admin/booking/edit_comm_home_banner.blade.php ENDPATH**/ ?>
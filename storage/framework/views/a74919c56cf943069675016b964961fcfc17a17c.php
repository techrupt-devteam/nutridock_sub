  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo e(url('/admin')); ?>/manage_nexa_booking">Manage <?php echo e($title); ?></a></li>
          ...
          <div class="row">  
            <div class="col-md-12">  
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                      <label for="oldpassword">Adhar Card:</label><span><a href="http://nexa.marutiseva.com/<?php echo e($data->adhar_card); ?>"> View</a></span>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box-body">
                      <label for="oldpassword">Pan Card:</label><span><a href="http://nexa.marutiseva.com/<?php echo e($data->pan_card); ?>"> View</a></span>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box-body">
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\marutiseva_live\admin\resources\views/admin/booking/view_nexa_booking.blade.php ENDPATH**/ ?>
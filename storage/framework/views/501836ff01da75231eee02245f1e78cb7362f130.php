        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <a href="<?php echo e(url('/admin')); ?>/add_<?php echo e($url_slug); ?>" class="btn btn-primary btn-sm" style="float: right;">Add Operation Manager</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <tbody>
                  ...
                  <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      ...
                      <td><?php echo e($value->area_name); ?></td>
                      <td>
...
<script type="text/javascript">
    ...
    {  
        ...
        swal({
          ...
          //alert(status);
           $.ajax({
                url: "<?php echo e(url('/admin')); ?>/status_operation_manager",
                type: 'post',
                data: {status:status,plan_ids:plan_id},
                success: function (data) 
                {
                  swal("Good job!", "Operation Manager status successfully changed !", "success");
                }
            });
          }
        });

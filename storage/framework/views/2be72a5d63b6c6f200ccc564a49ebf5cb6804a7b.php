...
<link rel="stylesheet" href="<?php echo e(url('')); ?>/public/front/css/subscribe.css" />
<main> 
 <div id="demo" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="<?php echo e(url('')); ?>/public/front/img/proper-nutrition.png" alt="Proper nutrition is the key to unlock your full potential. Subscribe to our meals daily and enjoy abundant health and deliciousness." style="max-height: 520px;width: 100%">
      <div class="carousel-caption">
        ...
        <!-- <form action="<?php echo e(url('')); ?>/search" target="blank" method="GET"> -->
    ...
    <div class="carousel-item">
      <img src="<?php echo e(url('')); ?>/public/front/img/Pre-workout.png" alt="Pre-workout nutrition is necessary for performance and post-workout nutrition is necessary for progress." style="max-height: 520px;width: 100%">
      <div class="carousel-caption">
    ...
    <div class="carousel-item">
      <img src="<?php echo e(url('')); ?>/public/front/img/expert-nutritionist.png" alt="You can’t fix your health, until you fix your diet. Reach your health goals with personalised meal plans by our expert nutritionist. " style="max-height: 520px;width: 100%">
      <div class="carousel-caption">
    ...
    <div class="carousel-item">
      <img src="<?php echo e(url('')); ?>/public/front/img/group-woman.png" alt="Exercise is king. Nutrition is queen. Put them together and you have got a kingdom. Let us help you build your kingdom. " style="max-height: 520px;width: 100%">
      <div class="carousel-caption">
    ...
    <div class="carousel-item">
      <img src="<?php echo e(url('')); ?>/public/front/img/eating-well.png" alt="Eating well is a habit. Cultivate it with our subscription plans customised as per your needs and loaded with flavours. " style="max-height: 520px;width: 100%">
      <div class="carousel-caption">
      ...
      <div class="row">
        <div class="col-lg-3 col-sm-6 mt-3">
          <div class="ltx-block-icon">
            <div class="in"> 
              <img src="<?php echo e(url('')); ?>/public/front/img/lede-gif-1554316333.gif" class="ltx-icon bg-main">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 mt-3">
          <div class="ltx-block-icon">
            <div class="in"> 
              <img src="<?php echo e(url('')); ?>/public/front/img/health-profile.gif" class="ltx-icon bg-main">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 mt-3">
          <div class="ltx-block-icon">
            <div class="in"> 
              <img src="<?php echo e(url('')); ?>/public/front/img/meal-plan.gif" class="ltx-icon bg-main">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 mt-3">
          <div class="ltx-block-icon remove-after">
            <div class="in"> 
              <img src="<?php echo e(url('')); ?>/public/front/img/delivered-to-your-doorstep.gif" class="ltx-icon bg-main">
    ...
    <div class="container-fluid pl-0 pr-0">
      <div class="row no-gutters">
        <div class="col-4">
          <article class="item__module">
            <figure class="item_img img-intro">
              <img src="<?php echo e(url('')); ?>/public/front/img/1-1.jpg" alt="" class="img-fluid">
            </figure>
        ...
        <div class="col-4">
          <article class="item__module">
            <figure class="item_img img-intro">
              <img src="<?php echo e(url('')); ?>/public/front/img/1-2.jpg" alt="" class="img-fluid">
            </figure>
            <div class="image_content">
              <div class="image_content_inner">
                <div class="wrapper">
        ...
        <div class="col-4">
          <article class="item__module">
            <figure class="item_img img-intro">
              <img src="<?php echo e(url('')); ?>/public/front/img/1-3.jpg" alt="" class="img-fluid">
            </figure>
            <div class="image_content">
              <div class="image_content_inner">
                <div class="wrapper">
  ...
  <section class="What-you-get">
    <div class="container">
      ...
      <div class="row row-xl row-30 row-md-40 row-lg-50 align-items-center">
          ...
          <div class="row row-30 row-md-40 row-lg-50 bordered-2">
            <div class="col-sm-6 col-md-12">
              <article class="box-icon-classic box-icon-nancy-right text-center text-lg-right">
                <div class="unit flex-column flex-lg-row-reverse">
                  <div class="unit-left">
                    <div class="box-icon-classic-svg"> <img src="<?php echo e(url('')); ?>/public/front/img/tailor-made-nutrition.svg" /> </div>
                  </div>
                  <div class="unit-body">
            ...
            <div class="col-sm-6 col-md-12">
              <article class="box-icon-classic box-icon-nancy-right text-center text-lg-right wow fadeInLeft">
                <div class="unit flex-column flex-lg-row-reverse">
                  <div class="unit-left">
                    <div class="box-icon-classic-svg"> <img src="<?php echo e(url('')); ?>/public/front/img/delicious-meals.svg" /> </div>
                  </div>
                  <div class="unit-body">
        ...
        <div class="col-md-2 col-xl-4 d-none d-md-block wow fadeScale"> <img src="<?php echo e(url('')); ?>/public/front/img/index-1-399x407.png" alt="" width="399" height="407" class="img-fluid"> </div>
        <div class="col-md-5 col-xl-4">
          <div class="row row-30 row-md-40 row-lg-50 bordered-2">
            <div class="col-sm-6 col-md-12">
              <article class="box-icon-classic box-icon-nancy-left text-center text-lg-left">
                <div class="unit flex-column flex-lg-row">
                  <div class="unit-left">
                    <div class="box-icon-classic-svg"> <img src="<?php echo e(url('')); ?>/public/front/img/sustainable-plans.svg" /> </div>
                  </div>
                  <div class="unit-body">
            ...
            <div class="col-sm-6 col-md-12">
              <article class="box-icon-classic box-icon-nancy-left text-center text-lg-left">
                <div class="unit flex-column flex-lg-row">
                  <div class="unit-left">
                    <div class="box-icon-classic-svg"> <img src="<?php echo e(url('')); ?>/public/front/img/personalised-nutritionist.svg" /> </div>
                  </div>
                  <div class="unit-body">
    ...
    <div class="container">
     <div class="row">  
      <div class="col-md-6  d-none d-md-block d-lg-block">
       ...
       <!--  <img src="<?php echo e(url('')); ?>/public/front/img/10.jpeg" alt="New York" style="max-height: 520px;width: 100%"> -->
      </div>
          ...
          <form>
            <div class="form-group">
              ...
              <div class="chk-toolbar has-error">
                <?php $__currentLoopData = $data['getMealTypeData']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $getMealTypeData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <input type="checkbox" id="radio<?php echo e($getMealTypeData['meal_type_name']); ?>" name="radioFruit[]" data-value="radioFruitValue" class="meal_type_id valid" value="<?php echo e($getMealTypeData['meal_type_id']); ?>" onclick="calculatePrice();" required="required" aria-required="true" aria-invalid="false">
                    <label for="radio<?php echo e($getMealTypeData['meal_type_name']); ?>"><?php echo e($getMealTypeData['meal_type_name']); ?></label>
            ...
            <div class="form-group">
              ...
              <div class="row">
                ...
                <div class="col-4 ">
                  ...
                  <?php $__currentLoopData = $data['getSubscribeNowPlan']['duration']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $duration_dtl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <option value="<?php echo e($duration_dtl['subscribe_now_duration']); ?>"><?php echo e($duration_dtl['subscribe_now_duration']); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  <!--<option>7</option>
                  <option>15</option>
                  <option>30</option>
            ...
            <!--<a href="<?php echo e(url('')); ?>/subscribe_now" class="btn btn-darkblue text-white">Get Started</a>-->
            <button type="submit" value="submit" class="btn btn-darkblue text-white" onclick="searchPincodeForm()">Get Started</button><br>
            
          </form>
          <a href="<?php echo e(url('')); ?>/faq" style="color: #222;" class="d-block mt-3"> <strong style="color: red;">*</strong> Please find answers to all your subscription related queries</a>
        </div>
      </div>
     </div> 
    </div>
        ...
        <div class="tab-content w-100">
          ...
          <div id="tab3" class="tab-pane">
            <div>
              ...
              <div class="meal-price-text">$11.49 / meal</div>
              <div class="meal-price-text bottom-padding"> </div>
              <a href="<?php echo e(url('')); ?>/subscribe_now" class="btn btn-success btn-lg">Select the 6 meal plan</a></div>
          </div>
  ...
  <section class="section bg-green"><!-- bg-default -->
    <div class="container">
        ...
        <div class="col-md-10 col-lg-8 p-2">
          ...
          <div class="row row-30 row-md-40 new-meal-card-parent fit">
            <div class="col-sm-6 col-md-4 col-6  pr-2 mb-3 fit-meal-card"> 
              <article class="product product-3">
                <div class="product-body">
                  <div class="product-figure"><img src="<?php echo e(url('')); ?>/uploads/images/15ed36a41ed2238aa0512bff66308d3ac215505d.jpg" class="img-fluid" /> </div>
            ...
            <div class="col-sm-6 col-md-4 col-6 pl-2 pr-2 mb-3 fit-meal-card"> 
              <article class="product product-3">
                <div class="product-body">
                  <div class="product-figure"><img src="<?php echo e(url('')); ?>/uploads/images/c7996dfb0ea8a0a92346a12cf6673ee6b07c3eb4.jpg" class="img-fluid" /> </div>
            ...
            <div class="col-sm-6 col-md-4 col-6 pl-2 pr-2 mb-3 fit-meal-card"> 
              <article class="product product-3">
                <div class="product-body">
                  <div class="product-figure"><img src="<?php echo e(url('')); ?>/uploads/images/95c7ae53605c065179545265ef5655305c095cf8.jpg" class="img-fluid" /> </div>
            ...
            <div class="col-sm-6 col-md-4 col-6  pr-2 mb-3 fit-meal-card"> 
              <article class="product product-3">
                <div class="product-body">
                  <div class="product-figure"><img src="<?php echo e(url('')); ?>/uploads/images/647399ddc20ecf2f6038977eb876c3bca6dd738b.jpg" class="img-fluid" /> </div>
            ...
            <div class="col-sm-6 col-md-4 col-6 pl-2 pr-2 mb-3 fit-meal-card"> 
              <article class="product product-3">
                <div class="product-body">
                  <div class="product-figure"><img src="<?php echo e(url('')); ?>/uploads/images/2accb5793e936a81e03b1d280f45dbae8e3bb0eb.jpg" class="img-fluid" /> </div>
              ...
              <article class="product product-3">
                <div class="product-body">
                  <div class="product-figure">
                    <img src="<?php echo e(url('')); ?>/uploads/images/91b3d9bf56d3344bec2dda10af5a85d61889f122.jpg" class="img-fluid" /> 
                  </div>
      ...
      <div class="helper-div ff text-center">
        ...
        <!--<a href="<?php echo e(url('')); ?>/subscribe_now" class="btn btn-darkblue">Get Started</a>-->
      </div>
    </div>
  </section>
  ...
  <div class="section-2 gray">
    <div class="container">
      ...
      <div class="row align-items-stretch justify-content-center">
        <div class="mt-2 col-md-4 col-4 p-2">
          <div class="child-column-fueled text-center">
            <img src="<?php echo e(url('')); ?>/public/front/img/perfect-protion.svg" class="img-fluid" width="180">
            <p class="ff-paragraph mt-2">Meals packed with ingredients that satiate you for long.</p>
          </div>
        </div>
        <div class="mt-2 col-md-4 col-4 p-2">
          <div class="child-column-fueled text-center">
            <img src="<?php echo e(url('')); ?>/public/front/img/power-macros.svg" class="img-fluid" width="180">
            <p class="ff-paragraph mt-2">Get power in every bite with the goodness of essential nutrients.</p>
          </div>
        </div>
        <div class="mt-2 col-md-4 col-4 p-2">
          <div class="child-column-fueled text-center">
            <img src="<?php echo e(url('')); ?>/public/front/img/paleo-keto.svg" class="img-fluid" width="180">
      ...
      <div class="container" style="text-align: center;">
        <a href="<?php echo e(url('')); ?>/faq#tab2" style="color: #222;" class="d-block mt-3"> <strong style="color: red;">*</strong> Please find answers to all your subscription related queries</a>
      </div>
...
$('.pincode').keydown(function(e) {
  ...
  $.ajax({
      ...
      success: function(response){
        ...
        window.location.href = '<?php echo e(url('')); ?>/subscribe-now'; 
      }else{
...
function searchPincodeForm(){
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo e(URL::to('/')); ?>/searchform",             
        data: {
...
function calculatePrice()
{
  ...
  $.ajax({
        type: "GET",
        url: "<?php echo e(URL::to('/')); ?>/getSubscribeNowPlanDuration/"+no_of_days,             
        dataType: "html",
        'async': false,
        success: function(response){ 

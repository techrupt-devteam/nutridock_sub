                ...
                <tbody>
                  ...
                  <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                      ...
                      <td><?php echo e($value['plan_name']); ?></td>
                      <td class="text-center">
                        ...
                        <?php endif; ?>
                        <input type="checkbox" <?php echo e($checked); ?> data-toggle="toggle" data-onstyle="success" title="status" onchange="change_Status(<?php echo $key+1; ?>,<?php echo $value['plan_id']; ?>);" data-offstyle="danger" id="<?php echo e($key+1); ?>_is_active" data-size="small" data-style="slow" >
                      
                        <a href="<?php echo e(url('/admin')); ?>/edit_<?php echo e($url_slug); ?>/<?php echo e($value['plan_id']); ?>" class="btn btn-primary btn-sm"  title="Edit">
                          <i class="fa fa-edit"></i>
                        </a>
                       
                        <a href="<?php echo e(url('/admin')); ?>/delete_<?php echo e($url_slug); ?>/<?php echo e($value['plan_id']); ?>" class="btn btn-default btn-sm" title="Delete" onclick="return confirm('Are you sure you want to delete this record?');">
...
<script type="text/javascript">
    ...
    {  
      ...
      swal({
        ...
        //alert(status);
         $.ajax({
              url: "<?php echo e(url('/admin')); ?>/plan_status",
              type: 'post',

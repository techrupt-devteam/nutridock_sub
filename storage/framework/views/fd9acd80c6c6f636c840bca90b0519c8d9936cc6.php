...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo e(url('/admin')); ?>/dashbord" class="logo">
      ...
      <!-- <span class="logo-mini" style="color: black"><img src="<?php echo e(url('/admin_css_js')); ?>/css_and_js/logo-mini.svg" style="width: 60%;"><h3>Nutridock</h3></span>
      logo for regular state and mobile devices
      <span class="logo-lg" style="color: black"><img src="<?php echo e(url('/admin_css_js')); ?>/css_and_js/logo-mini.svg" style="width:13%"></span> -->
      <img src="<?php echo e(url('/admin_css_js')); ?>/css_and_js/logo-mini.svg" style="width:13%"> <span><b>Nutridock</b></span>   
    </a>
...
<?php /**PATH D:\xampp\htdocs\nutridock_sub\admin\resources\views/admin/layout/header.blade.php ENDPATH**/ ?>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <a href="<?php echo e(url('/admin')); ?>/add_menu" class="btn btn-primary btn-xs" style="float: right;">Add Menu</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\marutiseva_live\admin\resources\views/admin/menu/index.blade.php ENDPATH**/ ?>
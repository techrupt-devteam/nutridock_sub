          ...
          <div class="box box-primary">
            ...
            <form action="<?php echo e(url('/admin')); ?>/update_offer/<?php echo e($data->id); ?>" method="post" role="form" data-parsley-validate="parsley" enctype="multipart/form-data">
              ...
              <div class="box-footer">
                <a href="<?php echo e(url('/admin')); ?>/commercial_offers" type="submit" class="btn btn-primary pull-right">Back</a>
              </div>
            </form>
          </div>
          <!-- /.box -->
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/marutiseva/public_html/admin/resources/views/admin/booking/view_commercial_offer.blade.php ENDPATH**/ ?>
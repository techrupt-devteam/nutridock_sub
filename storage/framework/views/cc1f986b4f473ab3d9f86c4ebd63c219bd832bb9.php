...
<script type="text/javascript" src="<?php echo e(url('')); ?>/public/front/dist/date-time-picker.min.js"></script>
<section class="mt-5 pb-0 pt-5">
  <div class="">
    <div class="image-container set-full-height pb-5" style="background-image: url('<?php echo e(url('')); ?>/uploads/images/1.jpeg');"> 
      <!--   Big container   -->
      <div class="container">
        <div class="row">

              ...
              <?php echo csrf_field(); ?>
               ...
               <div class="box-body">
                ...
                <div class="form-group">
                 ...
                 <input class="form-control" type="text" name="service_name" id="service_name" required="" value="<?php echo e($data->service_name); ?>" readonly="">
                </div>
                <div class="form-group">
                  <label for="oldpassword">Service Type<span style="color:red;" >*</span></label>
                   <input class="form-control" type="text" name="service_type" id="service_type" required="" value="<?php echo e($data->service_type); ?>" readonly="">
                </div>
                <div class="form-group">
                  <label for="oldpassword">Price<span style="color:red;" >*</span></label>
                    <input class="form-control" type="text" name="price" id="price" required="" value="<?php echo e($data->price); ?>" readonly="">
                </div>
                 <div class="form-group">
                  <label for="oldpassword">Description<span style="color:red;" >*</span></label>
                    <textarea class="form-control" type="text" name="description" id="description" required=""readonly=""> <?php echo e($data->description); ?></textarea> 
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <label for="oldpassword">Video Link<span style="color:red;" >*</span></label>
                    <input class="form-control" type="text" name="video_link" id="video_link" required="" value="<?php echo e($data->video_link); ?>" readonly="">
                </div>
              </div>
              <!-- /.box-body -->
              <div class="box-footer">
                <a href="<?php echo e(url('/admin')); ?>/value_add_services" type="submit" class="btn btn-primary pull-right">Back</a>
              </div>
            </form>
          </div>
          <!-- /.box -->
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/marutiseva/public_html/admin/resources/views/admin/booking/nexa_view_value_add_services.blade.php ENDPATH**/ ?>
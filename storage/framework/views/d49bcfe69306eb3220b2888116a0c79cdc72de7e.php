...
?>
 <!-- Left side column. contains the logo and sidebar -->
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li <?php if(Request::segment(2)=='booked_value_added_services' || Request::segment(2)=='booked_value_added_services'): ?> class="active" <?php endif; ?>>
         ...
         <li class="treeview  <?php if(Request::segment(2)=='manage_nexa_booking' || Request::segment(2)=='view_nexa_booking'||Request::segment(2)=='nexa_book_you_service' || Request::segment(2)=='nexa_book_you_service'||Request::segment(2)=='nexa_showroom_visits' || Request::segment(2)=='nexa_showroom_visits'||Request::segment(2)=='nexa_test_drive' || Request::segment(2)=='nexa_test_drive'||Request::segment(2)=='nexa_quotations' || Request::segment(2)=='nexa_quotations'||Request::segment(2)=='nexa_insurance' || Request::segment(2)=='nexa_insuranc'||Request::segment(2)=='nexa_finance' || Request::segment(2)=='nexa_finance'||Request::segment(2)=='nexa_feedback' || Request::segment(2)=='nexa_feedback'||Request::segment(2)=='nexa_enquiry' || Request::segment(2)=='nexa_enquiry'||Request::segment(2)=='nexa_offer_enquiry' || Request::segment(2)=='nexa_offer_enquiry'||Request::segment(2)=='nexa_locations' || Request::segment(2)=='nexa_locations'||Request::segment(2)=='nexa_offers' || Request::segment(2)=='nexa_offers'||Request::segment(2)=='nexa_home_banner' || Request::segment(2)=='nexa_home_banner'||Request::segment(2)=='nexa_value_add_services' || Request::segment(2)=='nexa_value_add_services'): ?> active <?php endif; ?>">
          <a href="#">
    ...
    <!-- /.sidebar -->
  </aside><?php /**PATH D:\xampp\htdocs\marutiseva_live\admin\resources\views/admin/layout/sidebar.blade.php ENDPATH**/ ?>
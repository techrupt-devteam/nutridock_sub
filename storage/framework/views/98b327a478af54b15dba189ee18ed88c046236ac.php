      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="<?php echo e(url('/admin')); ?>/update_commercial_offer/<?php echo e($data->id); ?>" method="post" role="form" data-parsley-validate="parsley" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="car_maker" name="car_maker" onchange="function_car()" required="true">
                    ...
                    <?php $__currentLoopData = $car; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($value->car); ?>" <?php if($data->car_maker==$value->car): ?> selected="" <?php endif; ?>><?php echo e($value->car); ?></option>
           ...
           <option value="">Select Varient</option>
                        <?php $__currentLoopData = $varient; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($value->varient); ?>" <?php if($data->varient==$value->varient): ?> selected="" <?php endif; ?>><?php echo e($value->varient); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
                </div>
                <div class="form-group">
            ...
            <option value="">Select Color</option>
                        <?php $__currentLoopData = $color; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($value->color); ?>" <?php if($data->color==$value->color): ?> selected="" <?php endif; ?>><?php echo e($value->color); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
                </div>
                 <div class="form-group">
                  <img id="output_image1" height="100px" width="110px" src="https://www.marutiseva.com/<?php echo e($data->image); ?>" style="border-radius: 50px" />
...
<?php echo $__env->make('admin.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/marutiseva/public_html/admin/resources/views/admin/booking/edit_commercial_offer.blade.php ENDPATH**/ ?>
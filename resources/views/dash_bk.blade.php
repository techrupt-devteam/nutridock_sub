                          ...
                          <table id="dtable" class="ui celled table table-responsive-sm">
                                ...
                                @foreach($data as $key=>$value)
                                    <tr>
                                      ...
                                      <td> 
                                        <button type='button' class='btn btn-info btn-sm' data-toggle='modal' data-target='#modal-details' onclick='viewDetails1({{$value->id}})' title='Meal Program calendar'><i class="fa fa-calendar" aria-hidden="true" style="font-size: 16px;"></i></button>

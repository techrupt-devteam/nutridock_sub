            ...
            <tr>
                <td style="border: 0 !important;width: 60%">
                    ...
                    <address class="norm" style="font-style: normal !important;margin-top: 5px !important;">
                        <h4 style="font-style: normal !important;">{{ucfirst($value['get_subscriber_details']->subscriber_name)}}</h4>
                        <p style="font-style: normal !important;"> {{$value['get_subscriber_details']->email}} <br>
                        <p style="font-style: normal !important;"> 
                        {{ucfirst($value['get_subscriber_details']->address1)}} <br>
                        <p style="font-style: normal !important;"> pincode: {{$value['get_subscriber_details']->pincode1}}<br>
                        <p style="font-style: normal !important;"> {{$value['get_subscriber_details']->mobile}}</p>
                    </address>
                </td>
                <td style="border: 0 !important;width: 40%">
                    <table class="meta" style="width: 100%">
                        <tr>
                            ...
                            <td><span >{{$value['get_subscriber_details']->transaction_id}}</span></td>
                        </tr>
                        <tr>
        ...
        <table class="inventory" style="border:1px solid #444">
            ...
            <tbody>
                <tr>
                    ...
                    <td style="width:10% !important;" align="left"><span>
                    {{date('d-m-Y',strtotime($value['get_subscriber_details']->start_date))}}</span></td>
                    <td align="left">
                    <span>{{ucfirst($value['get_subscriber_details']->sub_name)}}</span></td>
                    <td align="left">
                    <span>{{ $value['get_subscriber_details']->no_of_days}} Days</span></td>
                    <td style="text-align:left !important;">
                    <span>{{ $value['get_subscriber_details']->is_price_per_mealorpack}}</span></td>
                    <td style="text-align:right !important;"  align="right">₹ 
                    {{number_format($value['get_subscriber_details']->price_per_meal,2)}}</td> 
                </tr> 
            </tbody>
            <tfoot>
                <tr>
                    ...
                    <td style="text-align:right!important;"  align="right"  >
                        <span style="text-align:right!important;"  align="right">₹</span><span style="text-align:right!important;"  align="right">
                        {{number_format(round($value['get_subscriber_details']->discount_price),2)}}</span>
                    </td>
                </tr>
                <tr>
                    <th colspan="" style="text-align: left !important;">
                    ...
                    <td style="text-align:right!important;"  align="right" >
                        <span style="text-align:right!important;"  align="right">₹</span>
                        <span style="text-align:right!important;"  align="right">
                        {{number_format(round($value['get_subscriber_details']->mrp),2)}}</span>
                    </td>
                </tr>
                <tr>
                        <th colspan="" style="text-align: left !important;">
                    ...
                    <td style="text-align:right!important;"  align="right" >
                        <span style="text-align:right!important;"  align="right">₹</span><span style="text-align:right!important;"  align="right">
                        {{number_format(round($value['get_subscriber_details']->sale_price),2)}}</span>
                    </td>
                </tr>
                <tr>
                    <th colspan="" style="text-align: left !important;">
                    ...
                    <td style="text-align:right!important;"  align="right" >
                        <span style="text-align:right!important;"  align="right">₹</span><span style="text-align:right!important;"  align="right">
                        {{number_format(round($value['get_subscriber_details']->gst_price),2)}}</span>
                    </td>
                </tr>
                <tr>
                    <th colspan="" style="text-align: left !important;">
                    ...
                    <td style="text-align:right!important;"  align="right" >
                        <span style="text-align:right!important;"  align="right">₹</span><span style="text-align:right!important;"  align="right">
                        {{number_format(round($value['get_subscriber_details']->total_amount),2)}}</span>
                    </td>
                </tr>
                <tr>
                    <td colspan="6">
                        Inwards :
                        <b>{{ucfirst($value['inword'])}} only/- </b>
                    </td>
                </tr>
            </tfoot>
        </table>

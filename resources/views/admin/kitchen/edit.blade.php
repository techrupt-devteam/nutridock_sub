                ...
                <div class="col-md-6">
                    <div class="box-body">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="kitchen_name" name="kitchen_name" data-parsley-errors-container="#Kitchen_names" data-parsley-error-message="Please enter name."  placeholder="Kitchen Name" required="true" value="{{$data['kitchen_name']}}">
                        ...
                        <label for="operation_manager_name">Customer Key<span style="color:red;" >*</span></label>
                         <div class="input-group">
                            <div class="input-group-addon">
                             ...
                             <input  type="text"  class="form-control"  id="customer_key" name="customer_key" placeholder="Customer Key" required="true" data-parsley-errors-container="#customer_key_error" data-parsley-error-message="Please enter customer key." value="{{$data['customer_key']}}">
                          </div>
                        ...
                        <label for="operation_manager_name">Pincode<span style="color:red;" >*</span></label>
                         <div class="input-group">
                            <div class="input-group-addon">
                             ...
                             <input  type="text"  class="form-control"  id="pincode" name="pincode" placeholder="Pincode" required="true" data-parsley-errors-container="#pincode_error" data-parsley-error-message="Please enter pincode." value="{{$data['pincode']}}">
                          </div>
                  ...
                  <div class="col-md-8">
                    <div class="box-body">
                      <div class="form-group">
                        ...
                        <textarea name="address" class="form-control" id="address" rows="4" required="true" data-parsley-errors-container="#address_error" data-parsley-error-message="Please enter address.">{{$data['address']}}</textarea>

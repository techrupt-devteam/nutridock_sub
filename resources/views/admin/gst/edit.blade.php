                ...
                <div class="col-md-12">
                  ...
                  <div class="col-md-3">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" autocomplete="off" class="form-control" id="cgst" name="cgst" placeholder="CGST" required="true" ta-parsley-errors-container="#cgst_error" data-parsley-error-message="Please enter cgst." value="{{ (!empty($data['cgst']))?$data['cgst']:0 }}">
                  ...
                  <div class="col-md-3">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" autocomplete="off" class="form-control" id="sgst" name="sgst" placeholder="SGST" required="true" ta-parsley-errors-container="#sgst_error" data-parsley-error-message="Please enter sgst." value="{{ (!empty($data['sgst']))?$data['sgst']:0 }}">

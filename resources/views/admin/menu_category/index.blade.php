 ...
 <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script> 
  ...
  <script type="text/javascript">
    ...
    {  
      ...
      swal({
        title: "Menu category status",
        text: "Are You sure to change menu category status",
        icon: "warning",
          buttons: [
            'Cancel',
            'Yes, change it!'
          ...
          { 
            ...
            //alert(status);
             $.ajax({
                  url: "{{url('/admin')}}/status_menu_category",
                  type: 'post',
                  data: {status:status,plan_ids:plan_id},
                  success: function (data) 
                  {
                    swal("Success", "Menu category status successfully changed !", "success");
                  }
              });

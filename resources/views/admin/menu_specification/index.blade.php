...
@section('content')
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <a href="{{url('/admin')}}/add_{{$url_slug}}" class="btn btn-primary btn-sm" style="float: right;">Add Menu Specification</a>
            </div>
            <!-- /.box-header -->
                ...
                <tbody>
                  ...
                  @foreach($data as $key=>$value)
                    <tr>
                      ...
                      <td>{{$value['specification_title']}}</td>
  ...
  <script type="text/javascript">
    ...
    {  
      ...
      swal({
        title: "Menu Specification status",
        text: "Are You sure to change menu specification status",
        icon: "warning",
          buttons: [
            'Cancel',
            'Yes, change it!'
          ...
          { 
            ...
            //alert(status);
             $.ajax({
                  url: "{{url('/admin')}}/status_menu_specification",
                  type: 'post',
                  data: {status:status,plan_ids:plan_id},
                  success: function (data) 
                  {
                    swal("Success", "Menu Specification status successfully changed !", "success");
                  }
              });

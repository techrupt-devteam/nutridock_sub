                ...
                <div class="">
                  <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="specification_title" name="specification_title" placeholder="Specification Name" required="true" data-parsley-errors-container="#name_error" data-parsley-error-message="Please enter the specification name." autocomplete="off">

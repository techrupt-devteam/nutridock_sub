      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form action="{{url('/admin')}}/nexa_store_value_add_services" method="post" role="form" data-parsley-validate="parsley" enctype="multipart/form-data">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="oldpassword">Video Image<span style="color:red;" >*</span></label>
                     ...
                     <img id="output_image1" height="100px" width="100px" src="{{url('/')}}/css_and_js/top.png" />

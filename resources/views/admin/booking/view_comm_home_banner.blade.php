  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{url('/admin')}}/comm_home_banner">Manage {{ $title }}</a></li>
            ...
            <form action="{{url('/admin')}}/update_offer/{{$data->id}}" method="post" role="form" data-parsley-validate="parsley" enctype="multipart/form-data">
              ...
              <div class="box-body">
                 ...
                 <div class="form-group">
                  <img id="output_image1" height="200px" width="220" src="https://www.marutiseva.com/{{$data->banner}}"/>
              ...
              <div class="box-footer">
                <a href="{{url('/admin')}}/comm_home_banner" type="submit" class="btn btn-primary pull-right">Back</a>
              </div>
            </form>
          </div>
          <!-- /.box -->

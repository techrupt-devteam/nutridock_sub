  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="{{url('/admin')}}/manage_booking">Manage {{ $title }}</a></li>
          ...
          <div class="row">  
            <div class="col-md-12">  
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="box-body">
                      <label for="oldpassword">Adhar Card:</label><span><a href="https://www.marutiseva.com/{{$data->adhar_card}}"> View</a></span>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box-body">
                      <label for="oldpassword">Pan Card:</label><span><a href="https://www.marutiseva.com/{{$data->pan_card}}"> View</a></span>
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="box-body">

            ...
            <div class="box-header">
                  <div class="box-body">
                    <div class="form-group">
                       <a class="btn bg-navy btn-xs" href="{{url('/admin')}}/nexa_download_bookings" style="float: right;" >Download Excel</a>
                    </div>
                  </div>
              </div>
            <!-- /.box-header -->
                  ...
                  @foreach($data as $key=>$value)
                    <tr>
                      ...
                      <td>
                       ...
                       <a href="{{url('/admin')}}/view_nexa_booking/{{$value->id}}" title="View">
                          <i class="fa fa-eye"></i>
                        </a>
